      ...
      <div className="flex min-h-screen">
        ...
        <div className="flex-1 flex items-center justify-center bg-white">
          ...
          >
            ...
            {twoFaStage ? (
              <form onSubmit={handleTwoFaVerify} className="mt-8 space-y-6">
                <div className="space-y-5">
                  <div>
                    <label className="block text-sm font-semibold text-gray-700">Mã 2FA</label>
                    <input
                      type="text"
                      required
                      value={twoFaCode}
                ...
                <div className="mt-6">
                  <button
                    ...
                    className={`w-full flex justify-center items-center py-3 px-4 border border-black rounded-lg shadow-sm text-base font-medium text-white transform transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] ${twoFaLoading ? 'bg-blue-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500'}`}
                  >
                    {twoFaLoading ? 'Đang xác thực...' : 'Xác thực 2FA'}
                  </button>
                </div>
